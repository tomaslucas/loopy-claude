...
| [post-mortem-system.md](post-mortem-system.md) | ⏳ In Progress | **Autonomous learning**, session log analysis, `lessons-learned.md` persistence, structured lessons (Evitar/Usar/Razón), 20 items per section limit, semantic pruning, auto-trigger after productive modes, prompt integration (Phase 0 reads lessons) |
...
**Current Status:** 9 implemented, 1 in progress, 0 planned.
