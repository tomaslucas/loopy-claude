...
| [cli-agnostic-system.md](cli-agnostic-system.md) | ⏳ In Progress | **Multi-agent support**, external configuration (`loopy.config.json`), `--agent` flag, model name mapping, Claude Code + Copilot support, extensible design, backward compatible defaults |
...
**Current Status:** 8 implemented, 1 in progress, 0 planned.
